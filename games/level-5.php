...
<head>
    ...
    <title>Nivel 5: Futuro Simple - English Trainer</title>
    ...
    <script>
        $(document).ready(function() {
            ...
            function nextQuestion() {
                currentQuestion++;
                englishTrainer.updateLevelProgress(5, currentQuestion, score);
                ...
                resultsContainer.html(`
                    <div class="theory-container">
                        <div class="theory-content text-center">
                            ...
                            ${percentage >= 70 ? '<p style="color: #2ECC71; font-weight: 600;">¡Has completado todos los niveles!</p>' : '<p>Necesitas al menos 70% para completar el nivel.</p>'}
                            <div style="margin-top: 2rem;">
                                <h3>¡Enhorabuena!</h3>
                                <p>Has terminado todos los niveles de English Trainer.</p>
                                <p>Sigue practicando para perfeccionar tu inglés.</p>
                            </div>
                        </div>
                    </div>
